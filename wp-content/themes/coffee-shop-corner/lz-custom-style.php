<?php 
	...
	$coffee_shop_corner_site_tagline_color = get_theme_mod('coffee_shop_corner_site_tagline_color');
	if ( $coffee_shop_corner_site_tagline_color != '') {
		$coffee_shop_corner_custom_style .=' .logo p.site-description {';
			$coffee_shop_corner_custom_style .=' color:'.esc_attr($coffee_shop_corner_site_tagline_color).';';
		$coffee_shop_corner_custom_style .=' }';
	}
